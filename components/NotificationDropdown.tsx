...
export default function NotificationDropdown() {
  ...
  return (
    <div className="px-3 py-3 w-61 bg-white drop-shadow-md border-2 border-gray-100 absolute left-0 top-9 flex justify-between items-center">
      <p>
        <b className="text-red-800">{activeUsersCount ?? "?"}</b> مستخدمين مسجلين الدخول حاليًا
      </p>
