    ...
    <>
      <div className="w-[98%] mx-auto mt-4 bg-white shadow rounded-lg xs:px-3 py-3">
        <div className="px-3 flex gap-2 items-center">
          ...
          <Link href={`/admin/types/${type}/edit`} className="bg-gray-500 text-white border-gray-600 w-22 h-7 flex justify-center items-center rounded-xl text-sm hover:bg-gray-600 transition-all duration-150">
            <PencilSquareIcon className="w-5" />
            تحرير
          </Link>
          <Link href={`/admin/types/${type}/delete`} className="bg-red-800 text-white border-gray-600 w-22 h-7 flex justify-center items-center rounded-xl text-sm hover:bg-red-900 transition-all duration-150">
